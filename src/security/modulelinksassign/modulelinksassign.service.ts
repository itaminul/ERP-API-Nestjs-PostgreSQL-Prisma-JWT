...
export class ModulelinksassignService {
    ...
    async updateModuleAssign(@Param('id') id: number, @Body() body: UpdateModuleLinkAssing, authUserInfo) {
        const {moduleId,moduleLinkId,userLabel,permissionStatus, activeStatus} = body;
