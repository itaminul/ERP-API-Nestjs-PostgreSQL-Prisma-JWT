...
export class MeasurementsService {
  ...
  async create(
    @Body() createMeasurements: CreateMeasurementsDto,
    authUserInfo,
  ) {
    const { measurementName, measurementDescription, remarks } =
      createMeasurements;
  ...
  async update(
    @Param('id') id: number,
    @Body() updateMeasurements: UpdateMeasurementsDto,
    authUserInfo,
  ) {
    const { measurementName, measurementDescription, remarks, activeStatus } =
      updateMeasurements;
