...
export class ItemGroupService {
    ...
    async update(@Param('id') id: number, @Body() updateItemGroup: UpdateItemGroup, authUserInfo) {
        const { udId, groupName,groupDescription,remarks, activeStatus } = updateItemGroup
